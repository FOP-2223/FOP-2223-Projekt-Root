...
public class IOHelper {
    ...
    public static void initProblemPresets() {
        // problem 1
        InputStream problem1 = IOHelper.class.getResourceAsStream("presets/problem1.txt");
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(Objects.requireNonNull(problem1)))) {
        ...
        // problem 2
        InputStream problem2 = IOHelper.class.getResourceAsStream("presets/problem2.txt");
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(Objects.requireNonNull(problem2)))) {
            writeProblem(ProblemArchetypeIO.readProblemArchetype(reader));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
