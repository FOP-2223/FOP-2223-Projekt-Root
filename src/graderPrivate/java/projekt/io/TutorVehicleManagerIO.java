...
import projekt.solution.TutorVehicleManagerBuilder;
...
public class TutorVehicleManagerIO {
    ...
    public static VehicleManager readVehicleManager(BufferedReader reader, Region region) {
        ...
        VehicleManager.Builder builder = new TutorVehicleManagerBuilder();
    ...
    private static Location parseLocation(String x, String y) {
        return new TutorLocation(Integer.parseInt(x), Integer.parseInt(y));
    }
