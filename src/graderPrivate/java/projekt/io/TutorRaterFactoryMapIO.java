...
import projekt.solution.TutorAmountDeliveredRater;
import projekt.solution.TutorInTimeRater;
import projekt.solution.TutorTravelDistanceRater;
...
public class TutorRaterFactoryMapIO {

    private static final Map<String, Supplier<? extends Rater.FactoryBuilder>> DESERIALIZED_RATER_FACTORY_BUILDER = Map.of(
        InTimeRater.Factory.class.getName(), TutorInTimeRater.Factory::builder,
        AmountDeliveredRater.Factory.class.getName(), TutorAmountDeliveredRater.Factory::builder,
        TravelDistanceRater.Factory.class.getName(), TutorTravelDistanceRater.Factory::builder
    );
        ...
        try {
            ...
            while (!Objects.equals(line = reader.readLine(), "END RATER")) {
                ...
                if (line.startsWith("R ")) {
                    ...
                    if (builder instanceof TutorInTimeRater.FactoryBuilder inTimeBuilder) {
                    ...
                    } else if (builder instanceof TutorAmountDeliveredRater.FactoryBuilder amountDeliveredBuilder) {
                        amountDeliveredBuilder.setFactor(Double.parseDouble(serializedRater[2]));
                    } else if (builder instanceof TutorTravelDistanceRater.FactoryBuilder travelDistanceBuilder) {
