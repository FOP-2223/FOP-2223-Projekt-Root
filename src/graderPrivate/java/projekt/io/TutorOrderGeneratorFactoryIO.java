...
public class TutorOrderGeneratorFactoryIO {
    ...
    private static final Map<String, Supplier<? extends OrderGenerator.FactoryBuilder>> DESERIALIZED_ORDER_GENERATOR_FACTORY_BUILDER = Map.of(
        ...
        FridayOrderGenerator.Factory.class.getName(), TutorFridayOrderGenerator.Factory::builder
    );
        ...
        try {
            ...
            while (!Objects.equals(line = reader.readLine(), "END ORDER GENERATOR")) {
                ...
                if (line.startsWith("O ")) {
                    ...
                    if (builder instanceof TutorFridayOrderGenerator.FactoryBuilder fridayBuilder) {
