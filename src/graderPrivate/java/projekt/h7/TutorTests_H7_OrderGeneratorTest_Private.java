...
@TestForSubmission
public class TutorTests_H7_OrderGeneratorTest_Private {
    ...
    public void setup() throws ReflectiveOperationException {
        ...
        neighborhoodA = new TutorNeighborhood(region, "A", locationA, Set.of(locationB, locationC));
        neighborhoodB = new TutorNeighborhood(region, "B", locationB, Set.of(locationA, locationC));
        nodeC = new TutorNode(region, "C", locationC, Set.of(locationD, locationA, locationB));
        restaurantD = new TutorRestaurant(region, "D", locationD, Set.of(locationC, locationE), restaurantDFood);
        restaurantE = new TutorRestaurant(region, "E", locationE, Set.of(locationD), restaurantEFood);
