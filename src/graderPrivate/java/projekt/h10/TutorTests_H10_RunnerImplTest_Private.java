...
import projekt.solution.TutorFridayOrderGenerator;
import projekt.solution.TutorInTimeRater;
...
import static projekt.util.Utils_Private.callCreateSimulations;
import static projekt.util.Utils_Private.getOrderGeneratorFactory;
import static projekt.util.Utils_Private.getRaterFactoryMap;

@SuppressWarnings({"FieldCanBeLocal", "DuplicatedCode"})
@TestForSubmission
public class TutorTests_H10_RunnerImplTest_Private {
    ...
    public void setup() throws ReflectiveOperationException {
        vehicleManager1 = new TutorVehicleManager(new TutorRegion(), new DijkstraPathCalculator());
        orderGeneratorFactory1 = TutorFridayOrderGenerator.Factory.builder().setVehicleManager(vehicleManager1).build();
        raterFactory1 = TutorInTimeRater.Factory.builder().build();
        ...
        vehicleManager2 = new TutorVehicleManager(new TutorRegion(), new DijkstraPathCalculator());
        orderGeneratorFactory2 = TutorFridayOrderGenerator.Factory.builder().setVehicleManager(vehicleManager2).build();
        raterFactory2 = TutorInTimeRater.Factory.builder().build();
