...
import static projekt.util.Utils_Private.callPutEdge;
import static projekt.util.Utils_Private.callPutNode;
import static projekt.util.Utils_Private.createRegion;

@TestForSubmission
@SuppressWarnings({"FieldCanBeLocal", "DuplicatedCode"})
public class TutorTests_H2_RegionImplTest_Private {

    private final Location locationA = new TutorLocation(0, 0);
    private final Location locationB = new TutorLocation(1, 1);
    private final Location locationC = new TutorLocation(2, 2);
    private final Location locationD = new TutorLocation(3, 3);
    ...
    public void setup() throws ReflectiveOperationException {
        ...
        nodeA = new TutorNode(region, "A", locationA, Set.of(locationB, locationC));
        nodeB = new TutorNode(region, "B", locationB, Set.of(locationA, locationC));
        nodeC = new TutorNode(region, "C", locationC, Set.of(locationD, locationA, locationB));
        nodeD = new TutorNode(region, "D", locationD, Set.of(locationC));

        addNodesToRegion(region, nodeA, nodeB, nodeC, nodeD);

        edgeAB = new TutorEdge(region, "AB", locationA, locationB, 1);
        edgeBC = new TutorEdge(region, "BC", locationB, locationC, 2);
        edgeAC = new TutorEdge(region, "AC", locationA, locationC, 3);
        edgeCD = new TutorEdge(region, "CD", locationC, locationD, 4);
    ...
    public void testGetNode() throws ReflectiveOperationException {
        ...
        assertEquals(new TutorNode(region, "A", locationA, Set.of(locationB, locationC)),
        ...
        Context contextNotContains = contextBuilder()
            .add("location", new TutorLocation(4, 4))
            .build();

        assertNull(region.getNode(new TutorLocation(4, 4)), contextNotContains,
    ...
    public void testPutNodeException() throws ReflectiveOperationException {
        ...
        new TutorNode(region2, "E", locationA, Set.of(locationB, locationC));

        Region.Node node = new TutorNode(region2, "E", locationA, Set.of(locationB, locationC));
        try {
    ...
    public void testPutNodeSuccess() throws Throwable {
        ...
        Region.Node node = new TutorNode(region, "E", new TutorLocation(4, 4), Set.of(locationB, locationC));
        ...
        assertTrue(nodesMap.containsKey(new TutorLocation(4, 4)), context,
        ...
        assertSame(node, nodesMap.get(new TutorLocation(4, 4)), context,
    ...
    public void testGetEdgeNull() {
        ...
        Context context2 = contextBuilder()
            .add("locationA", locationA)
            .add("locationB", new TutorLocation(4, 4))
            .subject("RegionImpl#getEdge(Location, Location)")
            .build();

        assertNull(region.getEdge(locationA, new TutorLocation(4, 4)), context2,
    ...
    public void testGetEdgeComplex() {
        ...
        Context context2 = contextBuilder()
            .add("locationA", new TutorLocation(5, 5))
            .add("locationB", new TutorLocation(4, 4))
            .subject("RegionImpl#getEdge(Location, Location)")
            .build();

        assertNull(region.getEdge(new TutorLocation(5, 5), new TutorLocation(4, 4)), context2,
        ...
        assertNull(region.getEdge(new TutorLocation(5, 5), locationA), context3,
    ...
    public void testPutEdgeException() throws ReflectiveOperationException {
        ...
        Region.Node nodeA2 = new TutorNode(region2, "A2", locationA, Set.of());
        Region.Node nodeB2 = new TutorNode(region2, "B2", locationB, Set.of());
        addNodesToRegion(region2, nodeA2, nodeB2);

        Region.Edge edge = new TutorEdge(region2, "EF", locationA, locationB, 1);
        ...
        Region.Edge edge2 = new TutorEdge(region, "EF", locationA, locationB, 1);
        TutorLocation locationA = new TutorLocation(4, 4);
        ...
        Region.Edge edge3 = new TutorEdge(region, "EF", this.locationA, locationB, 1);
        Location locationB = new TutorLocation(4, 4);
    ...
    public void testPutEdgeAllEdges() throws Throwable {
        ...
        Region.Edge edge = new TutorEdge(region, "AD", locationA, locationD, 1);
    ...
    public void testPutEdgeComplex() throws Throwable {
        Context context = contextBuilder()
            .add("locationA", new TutorLocation(-1, -1))
            .add("locationB", locationA)
            .subject("RegionImpl#putEdge(Edge)")
            .build();
