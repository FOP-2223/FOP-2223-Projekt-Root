...
import static projekt.util.Utils_Private.addPendingOrders;
import static projekt.util.Utils_Private.addVehicleToOccupied;
import static projekt.util.Utils_Private.addVehicleToVehicleManager;
import static projekt.util.Utils_Private.callTick;
import static projekt.util.Utils_Private.getOccupiedNodes;
import static projekt.util.Utils_Private.getPendingOrders;
import static projekt.util.Utils_Private.setOccupiedNodes;
import static projekt.util.Utils_Private.setOccupiedOfVehicle;

@SuppressWarnings({"DuplicatedCode", "FieldCanBeLocal"})
@TestForSubmission
public class TutorTests_H9_BasicDeliveryServiceTest_Private {
    ...
    public void setup() throws ReflectiveOperationException {
        neighborhoodLocation = new TutorLocation(1, 1);
        neighborhoodLocation2 = new TutorLocation(3, 3);
        restaurantLocation = new TutorLocation(0, 0);
        restaurantLocation2 = new TutorLocation(2, 2);
        region = new TutorRegion();
        food = "food";
        foodList = List.of(food);
        restaurant = new TutorRestaurant(region, "R", restaurantLocation, Set.of(neighborhoodLocation, neighborhoodLocation2, restaurantLocation2), foodList);
        restaurant2 = new TutorRestaurant(region, "R2", restaurantLocation2, Set.of(restaurantLocation), foodList);
        neighborhood = new TutorNeighborhood(region, "N", neighborhoodLocation, Set.of(restaurantLocation));
        neighborhood2 = new TutorNeighborhood(region, "N2", neighborhoodLocation2, Set.of(restaurantLocation));
        edge = new TutorEdge(region, "RN", restaurantLocation, neighborhoodLocation, 1);
        edge2 = new TutorEdge(region, "RN2", restaurantLocation, neighborhoodLocation2, 1);
        edge3 = new TutorEdge(region, "RR2", restaurantLocation, restaurantLocation2, 1);
        ...
        vehicle = spy(new TutorVehicle(1, 3, vehicleManager, occupiedRestaurant));
