...
import static projekt.util.Utils_Private.addEdgeToRegion;
...
import static projekt.util.Utils_Private.callGetAllOccupied;
import static projekt.util.Utils_Private.callToOccupiedEdges;
import static projekt.util.Utils_Private.callToOccupiedNodes;
import static projekt.util.Utils_Private.createEdge;
import static projekt.util.Utils_Private.createNeighborhood;
import static projekt.util.Utils_Private.createNode;
import static projekt.util.Utils_Private.createOccupiedEdge;
import static projekt.util.Utils_Private.createOccupiedNeighborhood;
import static projekt.util.Utils_Private.createOccupiedNode;
import static projekt.util.Utils_Private.createOccupiedRestaurant;
import static projekt.util.Utils_Private.createRegion;
import static projekt.util.Utils_Private.createRestaurant;
import static projekt.util.Utils_Private.createVehicleManager;
import static projekt.util.Utils_Private.setOccupiedEdgeOfVehicleManager;
import static projekt.util.Utils_Private.setOccupiedNodeOfVehicleManager;

@SuppressWarnings("FieldCanBeLocal")
@TestForSubmission
public class TutorTests_H6_VehicleManager_Private {
    ...
    private final Location locationE = new TutorLocation(4, 4);
    ...
    public void setup() throws ReflectiveOperationException {
        ...
        nodeA = new TutorNeighborhood(region, "A", locationA, Set.of(locationB, locationC));
        ...
        nodeD = new TutorNode(region, "D", locationD, Set.of(locationC, locationE));
        restaurantE = new TutorRestaurant(region, "E", locationE, Set.of(locationD), List.of());
    ...
    public void testToOccupiedNodesNoSubtypes() throws ReflectiveOperationException {
        Location locationF = new TutorLocation(5, 5);
        Location locationG = new TutorLocation(6, 6);
