...
import static projekt.util.Utils_Private.getFieldRecursively;

@SuppressWarnings({"DuplicatedCode", "FieldCanBeLocal"})
@TestForSubmission
public class TutorTests_H3_NodeImplTest_Private {
    ...
    public void testGetEdge() throws ReflectiveOperationException {
        ...
        Region.Node nodeE = createNode(region, "E", new TutorLocation(4, 4), Set.of());
    ...
    public void testGetAdjacentNodes() throws ReflectiveOperationException {
        ...
        Location locationE = new TutorLocation(4, 4);
