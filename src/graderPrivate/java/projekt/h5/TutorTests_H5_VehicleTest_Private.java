...
import static projekt.util.Utils_Private.addVehicleToVehicleManager;
import static projekt.util.Utils_Private.callLoadOrder;
import static projekt.util.Utils_Private.callUnloadOrder;
import static projekt.util.Utils_Private.createPath;
import static projekt.util.Utils_Private.createVehicle;
import static projekt.util.Utils_Private.getMoveQueueOfVehicle;
import static projekt.util.Utils_Private.getOrdersOfVehicle;
import static projekt.util.Utils_Private.mockPathCalculator;
import static projekt.util.Utils_Private.setOccupiedOfVehicle;
import static projekt.util.Utils_Private.setOrdersOfVehicle;

@SuppressWarnings({"FieldCanBeLocal", "DuplicatedCode"})
@TestForSubmission
public class TutorTests_H5_VehicleTest_Private {
    ...
    public void setup() throws ReflectiveOperationException {
        ...
        edgeDE = new TutorEdge(region, "DE", locationD, locationE, 5);
    ...
    public void testMoveQueuedException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> vehicle.moveQueued(restaurantE, (v, t) -> {}), context,
