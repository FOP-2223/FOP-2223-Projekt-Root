...
@TestForSubmission
public class TutorTests_H8_AmountDeliveredRaterTest_Private {
    ...
    public void setup() throws ReflectiveOperationException {
        ...
        restaurant = new TutorRestaurant(region, "R", restaurantLocation, Set.of(), List.of(food));
        neighborhood = new TutorNeighborhood(region, "N", neighborhoodLocation, Set.of());
