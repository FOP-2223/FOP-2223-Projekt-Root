...
public class TutorTravelDistanceRater implements Rater {
    ...
    private TutorTravelDistanceRater(VehicleManager vehicleManager, double factor) {
    ...
    /**
     * A {@link Rater.Factory} for creating a new {@link TutorTravelDistanceRater}.
     */
    public static class Factory implements Rater.Factory {
        ...
        @Override
        public TutorTravelDistanceRater create() {
            return new TutorTravelDistanceRater(vehicleManager, factor);
        }
