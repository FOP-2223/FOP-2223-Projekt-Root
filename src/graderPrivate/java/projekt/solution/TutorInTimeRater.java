...
public class TutorInTimeRater implements Rater {
     ...
     */
    private TutorInTimeRater(long ignoredTicksOff, long maxTicksOff) {
    ...
    /**
     * A {@link Rater.Factory} for creating a new {@link TutorInTimeRater}.
     */
    @Override
    ...
    public static class Factory implements Rater.Factory {
        ...
        @Override
        public TutorInTimeRater create() {
            return new TutorInTimeRater(ignoredTicksOff, maxTicksOff);
        }

        /**
         * Creates a new {@link TutorInTimeRater.FactoryBuilder}.
         * @return The created {@link TutorInTimeRater.FactoryBuilder}.
         */
        public static TutorInTimeRater.FactoryBuilder builder() {
            return new TutorInTimeRater.FactoryBuilder();
        }
    }

    /**
     * A {@link Rater.FactoryBuilder} form constructing a new {@link TutorInTimeRater.Factory}.
     */
    public static class FactoryBuilder implements Rater.FactoryBuilder {
        ...
        public TutorInTimeRater.FactoryBuilder setIgnoredTicksOff(long ignoredTicksOff) {
            this.ignoredTicksOff = ignoredTicksOff;
            return this;
        }

        public TutorInTimeRater.FactoryBuilder setMaxTicksOff(long maxTicksOff) {
            this.maxTicksOff = maxTicksOff;
            return this;
        }

        @Override
        public TutorInTimeRater.Factory build() {
            return new TutorInTimeRater.Factory(ignoredTicksOff, maxTicksOff);
        }
    }
}
